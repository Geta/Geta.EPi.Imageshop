    ...
    function (
        ...
        return declare("geta-epi-imageshop/widgets/imageSelector", [_Widget, _TemplatedMixin, _WidgetsInTemplateMixin, _CssStateMixin, _ValueRequiredMixin, _HasChildDialogMixin], {
            ...
            _setValue: function (value) {
                ...
                if (this._started && this.validate() && !this.isContained) {
            ...
            onMessageReceived: function (event) {
                ...
                when(this.store.get("?permalink=" + encodeURIComponent(this.currentImage.url)), lang.hitch(this, function (extendedData) {
                    ...
                    topic.publish("geta-epi-cms.widgets.imageSelector.valueset", this.currentImage);
                    this.closeWindow();
            ...
            openWindow: function (evt) {
                ...
                this.createFrame();
                topic.publish("geta-epi-cms.widgets.imageSelector.windowopened", this);
            },
            ...
            closeWindow: function (evt) {
                ...
                this.onBlur();
                topic.publish("geta-epi-cms.widgets.imageSelector.windowclosed", this);
            }
        });
    });